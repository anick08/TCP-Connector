...
define("LIGTHING_URL", 	"192.168.0.160"); 			// IP address of TCP Bridge/Gateway
define("LIGHTING_PORT", "443");						// 443 for new firmware, 80 for legacy - If you don't know, leave it at 443

define("LOCAL_URL", 	"http://localhost/TCPLightingWebInterface-master2");		// Address of your webserver running this - this is used in runSchedule to call the API
define("SCHEME", 		(LIGHTING_PORT == 80) ? 'http' : 'https'); //Don't modify


define("USER_EMAIL", "axhill88@gmail.com"); 		// I think this is so you dont have to regenerate tokens if you run this script elsewhere
define("USER_PASSWORD", USER_EMAIL);				// can be anything
define("USE_TOKEN_FILE", 0); 						// store the token in a file vs hard coding it below otherwise fill in line 29
...
if( SCHEME == 'http'){
	...
	if(USE_TOKEN_FILE){
		...
		define("TOKEN", "nam52lfn4affbw70wba7pjft5fxog2ath3npd038");	// paste your token here once you get it - leave empty for 	legacy 
	}
}
